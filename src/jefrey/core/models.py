...
class Approval(Base):
    ...
    admin_bypass = Column(String(16), nullable=True, default=None)  # FASE 7: rastreamento de bypass admin
...
class LongTermMemory(_MemoryMixin, Base):
    __tablename__ = "longterm_memory"

    __table_args__ = (
        Index(
            "ix_longtermemory_embedding_hnsw",
            "embedding",
